...
function AdoptionForm() {
  ...
  style={{ maxWidth: "600px", cursor: "pointer", userSelect: "none", fontSize: "1rem" }}
>
  <span className="fw-bold ">← Volver</span> 
</Link>
      <div className="container d-flex justify-content-center mt-5 mb-5">
        <div className="card rounded shadow p-4" style={{ maxWidth: "600px", width: "100%" }}>
          <h2 className="mb-4 text-center">Quiero Adoptar</h2>
<div
  className="d-flex justify-content-center gap-3 p-3 mb-5 rounded shadow"
  style={{ border: "1px solid #ccc", maxWidth: "100%", overflow: "hidden" }}
>
  <img
  ...
  />
          ...
          <form>
            ...
            <div className="mb-3">
              ...
              <input type="email" className="form-control" placeholder="Mail@mail.com" />
            </div>
            <div className="mb-3">
              <label className="form-label">Teléfono</label>
              <input type="text" className="form-control" placeholder="099 123 456" />
            ...
            <div className="mb-3">
              ...
              <textarea className="form-control" rows="3" placeholder="Escribe aquí tu motivo..." />
            </div>
