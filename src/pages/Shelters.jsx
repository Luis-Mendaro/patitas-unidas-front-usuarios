      ...
      <main className="container py-5">
        ...
        <div className="row mb-5">
          <div className="col-12 text-center">
            ...
            <p className="lead text-secondary">
              Conoce los refugios que forman parte de nuestra comunidad y
              trabajan para encontrar un hogar lleno de amor para cada animal
            </p>
          </div>
        </div>
        ...
        <div className="row mt-5">
          <div className="col-12">
            <div className="text-center p-5 rounded bg-body">
              <h3 className="fw-bold mb-3">¿Tienes un refugio?</h3>
              <p className="mb-4">
                Únete a nuestra comunidad y ayuda a más animales a encontrar un
                hogar
              </p>
              <a
                href={`${import.meta.env.VITE_FRONT_SHELTER_URL}/registro`}
